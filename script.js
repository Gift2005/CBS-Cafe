...
(function() {
  ...
  var schedule = {
    0: { open: 10.5, close: 20 },
    1: null,
    2: { open: 10.5, close: 20 },
    3: { open: 10.5, close: 20 },
    4: { open: 10.5, close: 20 },
    5: { open: 10.5, close: 22 },
    6: { open: 10.5, close: 22 }
  };
  ...
  if (!today) {
    ...
    if (h)  { h.textContent  = 'Closed on Mondays'; }
  } else {
